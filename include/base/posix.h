 ...
 *
 * base/posix.h -- include POSIX and system headers
 */
#pragma once
 ...
 *
 * Kernels shipped since 2.6.25 have set the rt_bandwidth value for the default
 * group to be 0.95 out of every 1.0 seconds. In other words, the group
 * scheduler is configured, by default, to reserve 5% of the CPU for tasks not
 * scheduled by the realtime policies SCHED_FIFO and SCHED_RR.
 *
 ...
 *
 * @return True if the above files read the default values mentioned above,
 *         false otherwise.
 */
bool
...
/**
 * Trigger a thread context switch.
 */
inline
void
yield() {
...
/**
 * @param jiffy: Some short amount of time (runs for 0..jiffy).
 */
inline
void
