...
namespace preempt {
  ...
  namespace this_process {
     ...
     * memory manager. To disable pagefaults all pages must be locked before
     * calling pthread_create() for SCHED_FIFO or SCHED_RR.
     *
     * After this function returns the code is protected from page locks.
